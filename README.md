...
> Aplicação de sorteio que gera um número de 1 a 100 ao carregar a página, e outros a cada 5s após o clique do botão. Parte integrante do desafio React proposto pelo @JCDMeira, que consiste em concluir 20 desafios em 7 dias. Utilizei ReactJS e NextJS.
